...
ggsave(paste0(plotDir, "READ_alluvial_RFall-vs-RF20.pdf"))
...
pred_VU_RF$SampleID <- VU_rc_vst$Sample.ID 
...
ggsave(paste0(plotDir, "FigS2_VU_alluvial_miR_RFallvsRF20.pdf"))
...
#### confidence boxplots ####
ggplot(wideVU, aes(CMS.miR_RF_20, d2ndProb_20) ) + 
  geom_boxplot(aes(group = CMS.miR_RF_20, fill=factor(CMS.miR_RF_20))) +
  scale_fill_manual(values=paletteCMS, name="CMS") +
  theme_minimal()
ggsave(paste0(plotDir, "Fig2d_VU_best-RF-20-all_confidence_d2ndProb_boxplot.pdf")
       , useDingbats=FALSE)
...
ggplot(wideVU, aes(purity, d2ndProb_20) ) + 
  ...
  geom_smooth(aes(color=factor(wideVU$CMS.miR_RF_20), 
              ...
              method = "lm", show.legend = F) +
  stat_cor()
ggsave(paste0(plotDir, "FigS2_VU_best-RF-20-all_Purity-vs-d2ndProb_correlation.pdf"),
       width=6, height=6, useDingbats=FALSE)
