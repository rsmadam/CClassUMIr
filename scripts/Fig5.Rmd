...
# ##skip because TCGA survival data not reliable
...
# pdf(paste0(plotDir,
#            "Fig5_SURV_COAD-rc-vst-445-cms-lv.pdf"),
...
VU_vst_surv <- VU_vst_surv[which(grepl("prim",#allMet
...
##checked also MSI but there were only 3 MSI cases and the 3 CMS1 were ND/failed
